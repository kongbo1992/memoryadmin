...
/* @var $searchModel backend\modules\models\models\TbModuleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '模块管理';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tb-module-index">
    ...
    <?php $gridColumns=[
        ...
        [
            ...
            'template' => '{photo-index} {update} {delete}',
            'header' => '操作',
            'buttons' => [
                'photo-index' => function ($url, $model, $key) {
                    return Html::a('图片管理', ['photo-index','pid'=>$model->id],['data-pjax'=>'0','class'=>'btn btn-success btn-sm'] );
                },
...
//            Html::a('<i class="glyphicon glyphicon-refresh"> 更新缓存</i>', ['push'], ['data-pjax'=>0, 'class'=>'btn btn-danger',  'data-confirm' => '确认更新缓存？',  'title'=>"更新缓存"]),
            Html::a('<i class="glyphicon glyphicon-plus"> 相册添加</i>',['create'], ['data-pjax'=>0, 'class'=>'btn btn-success', 'title'=>"广告添加"]),
